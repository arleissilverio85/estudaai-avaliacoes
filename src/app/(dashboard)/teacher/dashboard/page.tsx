...
import { School, BookOpen, Users, FileCheck } from 'lucide-react'
    ...
    <div className="space-y-8 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div className="flex items-center gap-4 rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm">
          ...
          <div>
            ...
            <p className="text-2xl font-black text-slate-900">{classrooms.length}</p>
          </div>
        </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-bold text-slate-900">Suas Salas de Aula</h2>
        ...
        {classrooms.length === 0 ? (
          <div className="flex flex-col items-center justify-center rounded-3xl border-2 border-dashed border-slate-200 bg-white p-12 text-center">
            ...
            <h3 className="mt-4 text-base font-bold text-slate-900">Nenhuma sala criada ainda</h3>
